...
if __name__ == '__main__':
    ...
    train_file = 'dataset/cnn_dailymail/train.csv'
    ...
    validation_file = 'dataset/cnn_dailymail/validation.csv'
    ...
    test_file = 'dataset/cnn_dailymail/test.csv'
    dataset_test = CSVDataset(test_file, tokeniser, max_length=768, subset_size=int(args.subset_size/10))
    ...
    if args.is_train:
        ...
        print('saving model')
        torch.save(model.state_dict(), f'../models/summarization.pth')
    else:
        print('evaluating model')
        model.load_state_dict(torch.load(f'../models/summarization.pth'))
